        ...
        <div class="hb-room-content">
            ...
            <div class="hb-room-info">
                ...
                <ul class="hb-room-meta">
                    ...
                    <li class="hb_search_max_child" title="Max Children : 2">
                        <label><?php _e( 'Max Children:', 'wp-hotel-booking' ); ?></label>
                        <div><?php echo esc_html( $room->max_child ); ?>
						<?
						$infant = "Children : Under the age of Six";?>
						 <input type="checkbox" class="childhelp" name="childhelp" width="10" height="10" title="<? _e( 'Children : Under the age of Six', 'wp-hotel-booking' );?>" disabled="true" checked="true" style="width:20px; height:20px; float:right;">
						</div>
                    </li>
