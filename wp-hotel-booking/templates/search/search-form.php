    ...
    <form name="hb-search-form" action="<?php echo hb_get_url(); ?>"
        ...
        <ul class="hb-form-table">
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input hb_input_field">
                    <input type="text" name="check_in_date" id="check_in_date_<?php echo esc_attr( $uniqid ); ?>"
                           class="hb_input_date_check" autocomplete="off" value="<?php echo esc_attr( $check_in_date ); ?>"
            ...
            <li class="hb-form-field">
                ...
                <div class="hb-form-field-input hb_input_field">
                    <input type="text" name="check_out_date" id="check_out_date_<?php echo esc_attr( $uniqid ) ?>"
                           class="hb_input_date_check" autocomplete="off" value="<?php echo esc_attr( $check_out_date ); ?>"
            ...
            <li class="hb-form-field">
				...
				?>
				<a href="#" class="child_tooltip"><i class="far fa-question-circle" title="<? _e( 'Children : Under the age of Six', 'wp-hotel-booking' );?>" style="float:right; font-size:20px; vertical-align:top;"></i></a>
				
                <div class="hb-form-field-input" title="Children : Under the age of Six">
					<?php
					hb_dropdown_numbers(
						array(
							'name'              => 'max_child',
